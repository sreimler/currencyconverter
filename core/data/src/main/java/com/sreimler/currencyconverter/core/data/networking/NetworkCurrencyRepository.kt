...
import com.sreimler.currencyconverter.core.data.mappers.toCurrencySerializable
import com.sreimler.currencyconverter.core.data.mappers.toExchangeRate
            ...
            CURRENCIES_LIST.find { currency -> currency.code == code }?.let {
                exchangeRates.add(
                    ExchangeRateSerializable(
                        ...
                        rate = rate,
                        dateTimeUtc = System.currentTimeMillis() // TODO: get UTC datetime
                    )
                )
            }
        }
